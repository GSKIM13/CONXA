...
class ConvNeXt_V2_CASE2_LN(nn.Module):
    ...
    def forward(self, x):
        ...
        return depth_concat, normal_concat, ref_concat, illu_concat
...
for img in img_list:
  ...
  for i in range(4): 
    ...
    for j in range(len(result)):
      ...
      ax.set_xlabel('')
      ax.set_ylabel('')
      os.makedirs(f'/home/gwangsoo13kim/EdgeSementic/EDTER_TriDecTr_GS/bimla_feat_map_new_/', exist_ok = True)
      plt.savefig(f'/home/gwangsoo13kim/EdgeSementic/EDTER_TriDecTr_GS/bimla_feat_map_new_/{img}_{dict_[i]}_{j}.png')
      plt.show()
      plt.close()
