...
for img in img_list:
  ...
  for i in range(4): 
    ...
    for j in range(len(result)):
      ...
      ax.set_xlabel('')
      ax.set_ylabel('')
      os.makedirs(f'/home/gwangsoo13kim/EdgeSementic/EDTER_TriDecTr_GS/bimla_feat_map_each/', exist_ok = True)
      plt.savefig(f'/home/gwangsoo13kim/EdgeSementic/EDTER_TriDecTr_GS/bimla_feat_map_each/{img}_{i}_{j}.png')
      plt.show()
      plt.close()
