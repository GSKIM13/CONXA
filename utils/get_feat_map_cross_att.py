...
class ConvNeXt_V2_CASE2_LN(nn.Module):
    ...
    def forward(self, x):
        ...
        attention = self.softmax(energy / (self.scale))  # (2,4,128)
...
file_path = '/home/gwangsoo13kim/EdgeSementic/EDTER_TriDecTr_GS/work_dirs/case3_best_/iter_4000.pth'
...
for img in img_list:
  ...
  for i in range(4):
    ...
    for j in range(len(result)):
      ...
      ax.set_xlabel('')
      ax.set_ylabel('')      
      os.makedirs(f'/home/gwangsoo13kim/EdgeSementic/EDTER_TriDecTr_GS/convnext_cross_att_new/', exist_ok = True)
      plt.savefig(f'/home/gwangsoo13kim/EdgeSementic/EDTER_TriDecTr_GS/convnext_cross_att_new/{img}_{dict_[i]}_{j}.png')
      plt.show()
      plt.close()
