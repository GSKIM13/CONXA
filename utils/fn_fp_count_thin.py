...
for result_path in result_paths:
    ...
    for iter_ in iters:
      ...
      for pred_type in types:
        ...
        threshold_path = os.path.join(result_path_folder, result_path, iter_, 'mat', pred_type, 'nms-eval', 'eval_bdry.txt')
        ...
        for img in img_list:
            result_path_ = os.path.join(result_path_folder, result_path, iter_, 'mat', pred_type, 'nms-eval', img[:-4]+'_ev1.txt')
