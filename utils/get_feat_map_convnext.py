...
for img in img_list:
  ...
  for i in range(4):
    ...
    for j in range(len(result)):
      ...
      plt.title('img')
      os.makedirs(f'/home/gwangsoo13kim/EdgeSementic/EDTER_TriDecTr_GS/feat_map_convnext/', exist_ok = True)
      plt.savefig(f'/home/gwangsoo13kim/EdgeSementic/EDTER_TriDecTr_GS/feat_map_convnext/{img}_{i}_{j}.png')
      plt.show()
      plt.close()
