...
model = dict(
    ...
    decode_head=dict(
        ...
        norm_cfg=dict(type='SyncBN', requires_grad=True),
        align_corners=False,
        loss_decode=dict(type='ConvNeXtLoss', use_sigmoid=True, attention_coeff=1.0, beta = 8, gamma =0.5, dice_coeff = 0, rev_dice_coeff = 1000000),
        category_emb_dim=1216)
