...
def hed_loss_ori_dice(pred,
    ...
    for b_i in range(batch):
        ...
        #print("===")
        #print(num_pos)
        #print( torch.sum(mask, dim=[2, 3]).float())
        #print(t)
        #print(class_weight)
        #exit()
...
class HEDLoss_DICE(nn.Module):
    ...
    def __init__(self,
                 ...
                 class_weight=None,
                 loss_weight=1.0):
        super(HEDLoss_DICE, self).__init__()
        ...
        self.cls_criterion = hed_loss_ori_dice
