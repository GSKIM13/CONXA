...
#        class_weight[t <= 0.5] = num_pos / (num_pos + num_neg)
        ...
        target[t > 0.5] = 1.0
#        class_weight = target * alpha * (4 ** ((1.0 - p_clip) ** 0.5)) * 0.5 + \
#                (1.0 - target) * (1.0 - alpha) * (4 ** (p_clip ** 0.5)) * 0.5

        class_weight = target * alpha * (-1.0 * (p_clip ** 6.0) + 1.0) + \
                (1.0 - target) * (1.0 - alpha) * (-1.0 * ((1.0 - p_clip) ** 6.0) + 1.0)
