...
class HEDLoss_ATTENTION(nn.Module):
    """HEDLoss.
    Args:
    ...
    def __init__(self,
                 ...
                 beta = 2,
                 gamma = 0.5):
        super(HEDLoss_ATTENTION, self).__init__()
    ...
    def hed_loss_rind_only(self, pred,
                 label,
                 weight=None,
                 reduction='mean',
                 avg_factor=None,
    ...
    def forward(self,
        ...
        loss_cls = self.loss_weight * self.hed_loss_rind_only(
            cls_score,
            label,
            weight,
