...
class ConvNeXt_Head_CASE4(BaseDecodeHead):
    ...
    def __init__(self, img_size=768, middle_channels=256, head_channels=128, 
        ...
        super(ConvNeXt_Head_CASE4, self).__init__(**kwargs)
        ...
        self.global_features_depth = nn.Sequential(
            nn.Conv2d(self.head_channels, self.head_channels, 3, padding=1), build_norm_layer(self.norm_cfg, [self.head_channels,320,320])[1], nn.Conv2d(self.head_channels, self.head_channels, 1), nn.GELU())
