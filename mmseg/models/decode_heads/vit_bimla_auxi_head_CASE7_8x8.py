...
class VIT_BIMLA_AUXIHead_CASE7_8x8(BaseDecodeHead):
    """ Vision Transformer with support for patch or hybrid CNN input stage
    """
    def __init__(self, img_size=768, **kwargs):
        super(VIT_BIMLA_AUXIHead_CASE7_8x8, self).__init__(**kwargs)
        ...
        nn.ConvTranspose2d(self.div_channels, self.div_channels, 4, stride=2, padding=1, bias=False),
                ...
                nn.ConvTranspose2d(self.div_channels, 1, 8, stride=4, padding=2, bias=False)
        ...
        self.aux_depth = nn.Sequential(
            nn.Conv2d(self.div_channels, self.div_channels, 3, padding=1, bias=False),
            nn.BatchNorm2d(self.div_channels), nn.ReLU(),
            nn.Conv2d(self.div_channels, 32, 3, padding=1, bias=False),
