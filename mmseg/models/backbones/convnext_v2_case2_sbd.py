...
class ConvNeXt_V2_CASE2_SBD(nn.Module):
    ...
    def __init__(self, in_chans=3, model_name = 'convnext_large_224', num_classes=1000, mla_channels=256, mla_index = (0,1,2,3),
                 ...
                 layer_scale_init_value=1e-6, head_init_scale=1., norm_cfg = None, norm_layer=partial(nn.LayerNorm, eps=1e-6), category_emb_dim = 128, scale = 64
                 ):
        super().__init__()
        ...
        self.scale = self.category_emb_dim
        ...
        #self.category_embedding = nn.Parameter(torch.rand(6400, self.category_emb_dim))
